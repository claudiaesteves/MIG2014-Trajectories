...
It should be emphasized here, that all control points (entry and exit) keeps their own proposal lists.
...
\memo {big enough number, not sure if there is a better word.} 
...
Splines are a good first approach for smoothing trajectories, but other techniques may be tried in the future to make them more similar to human trajectories.
