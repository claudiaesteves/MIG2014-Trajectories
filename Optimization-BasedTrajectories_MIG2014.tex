...
\teaser{
  ...
  \caption{
  	A patch is a time-periodic clip of crowd motion.
  	Given a set of spatio-temporal input and output control points,
  	an optimization based approach is used to generate crowd motion that can be used to generate high quality crowd patches.
  }
}
