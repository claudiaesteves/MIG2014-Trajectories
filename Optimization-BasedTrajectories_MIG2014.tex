...
% \author{
% Jose Guillermo Rangel Ramirez\thanks{e-mail:josguil@cimat.mx}
% Panayiotis Charalambous\thanks{e-mail:pcharala@inria.fr}
% 
% \\
...
This paper concentrates in improving the \emph{crowd patches} approach proposed by Yersin et al.~\cite{Yersin:2009} that aims in efficiently animating ambient crowds in a scene.
