...
% 	Jose Guillermo Rangel Ramirez{$^1$}\thanks{e-mail:josguil@cimat.mx}~
% 	Devin Lange{$^2$}\thanks{e-mail:ange604@umn.edu}~
% 	Panayiotis Charalambous{$^3$}\thanks{e-mail:pcharala@inria.fr}\\
% 	Marc Christie{$^3$}\thanks{e-mail:marc.christie@irisa.fr}~
% 	Claudia Esteves{$^1$}\thanks{e-mail:cesteves@cimat.mx}~
% 	Julien Pettre{$^3$}\thanks{julien.pettre@inria.fr}
% 	\\\\
% 	$^1$ Centro de Investigacion en Matematicas, A.C. (CIMAT), Mexico
% 	$^2$ University of Minnesota, USA
% 	$^3$ Inria-Rennes, France
...
\pdfauthor{Jose Guillermo Rangel Ramirez, Devin Lange, Panayiotis Charalambous, Marc Christie, Claudia Esteves, Julien Pettr\'e}
...
\teaser{
  \includegraphics[width=.99\linewidth]{./images/teaser.pdf}
%LINE WIDTH SHOULD NOT BE OVER 0.99
...
%(or any other living entities such as animals)
